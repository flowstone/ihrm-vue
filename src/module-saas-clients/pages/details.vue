                ...
                <el-tab-pane label="企业信息" name="first">
                    ...
                    <el-form ref="form" :model="formData" label-width="200px">
                        ...
                        <el-form-item label="公司地址">
                            <el-input v-model="formData.companyAddress" style="width:250px" disabled />
                        </el-form-item>
                        <el-form-item label="公司电话">
                            <el-input v-model="formData.companyPhone" style="width:250px" disabled />
                        </el-form-item>
                        <el-form-item label="邮箱">
                            <el-input v-model="formData.mailbox" style="width:250px" disabled />
                        </el-form-item>
